...
cl_context OpenCLInitHelper::CreateContext() {
    cl_int errNum;
...
cl_command_queue OpenCLInitHelper::CreateCommandQueue(cl_context context, cl_device_id *device) {
    cl_int errNum;
...
cl_program OpenCLInitHelper::CreateProgram(cl_context context, cl_device_id device, const char* fileName) {
    cl_int errNum;
    cl_program program;
